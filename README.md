...
팀 프로젝트 · 이봉헌은 화면과 외부 API 연동 및 상태 처리를 담당.

| 담당 작업 | 코드 변경 |
|---|---|
| 구독 요청 흐름 통합과 필터·AI 상태 처리 수정 | [변경 내용](https://github.com/kara320090/apt-alert-frontend/commit/19a042ff4eefcfa194255b8eee4554c7e2d11f71) |
| 지도 좌표 캐시와 장소 조회 요청 제한 구현 | [변경 내용](https://github.com/kara320090/apt-alert-frontend/commit/a7e1bf791f21c4beed7b2fc9bfc79f04c9464cca) |
| 입지 태그 요청 동시성 제한과 LRU 캐시 적용 | [변경 내용](https://github.com/kara320090/apt-alert-frontend/commit/3bb532071d8e3eb03dbf4f530b1fe11489ebae15) |
| 이메일 구독 폼과 구독 해제 API 연결 | [변경 내용](https://github.com/kara320090/apt-alert-frontend/commit/adaee04327e4cf5ee8516c9461585cc4a5f4d706) |
